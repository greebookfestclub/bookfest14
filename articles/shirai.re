...
//image[shirai-img/技術書典14_32][ChatGPTにアイドルの曲を作詞作曲MIDI生成までさせてみた]{ 
//}
...
//image[shirai-img/shirai-img/技術書典14_44][メタバース時代に学生を育てる価値とは]{ 
//}
...
そういえばこの時期「OpenAIサム・アルトマンCEO単独インタビュー」などを放映しておられました（3月25日）。
テレ東さんがプロの驚き屋さんと化していた印象です。

//image[shirai-img/技術書典14_46][ChatGPT時代、日本はどんなチャンスを持っているか？ #WBSのAI特番]{ 
//}
...
//image[shirai-img/技術書典14_58][AIサービス開発において開発しながら大事なことを書いていたらこんな時間に…]{ 
//}


=== メタバース研究者が考える生成AI時代のスピード感　#140秒でわかるメタバース開発TIPS  (2023-04-26)

//image[shirai-img/技術書典14_59][メタバース研究者が考える生成AI時代のスピード感　#140秒でわかるメタバース開発TIPS ]{ 
//}
...
//image[shirai-img/技術書典14_60][VRのタクソノミーに関する研究まとめ]{ 
//}


=== StabilityAIが東工大で講演を行っていたので聴講した（ぼくの感想） (2023-04-30)

//image[shirai-img/技術書典14_61][StabilityAIが東工大で講演を行っていたので聴講した（ぼくの感想）]{ 
//}


=== 生成AI時代のカンブリア爆発を生き抜くために…連休は性癖を走らせるまえに(謝辞と補足) (2023-05-02)

//image[shirai-img/技術書典14_62][生成AI時代のカンブリア爆発を生き抜くために…連休は性癖を走らせるまえに(謝辞と補足)]{ 
//}

=== 「生成AI利用のガイドライン」にモヤモヤしたクリエイター側のガードライン (2023-05-03)

//image[shirai-img/技術書典14_63][「生成AI利用のガイドライン」にモヤモヤしたクリエイター側のガードライン]{ 
//}


=== OpenAIの裏APIを叩いて利用状況を取得する (2023-05-07)

//image[shirai-img/技術書典14_64][OpenAIの裏APIを叩いて利用状況を取得する]{ 
//}"
...
以上です、他の人のページ配分もあると思いますのでいったんこの辺で終わります！（しらいはかせ／白井暁彦）